...
export default function OrganizationEdit({ params }: Props) {
  ...
  useEffect(() => {
    const fetchOrganization = async () => {
      try {
        ...
        const data = await getOrganization(resolvedParams.id)
        if (!data) {
    ...
    return (
      <>
        <div className="flex items-center gap-4">
          <Link href="/organizations" className="text-zinc-600 hover:text-zinc-900 transition-colors">
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="mx-auto max-w-7xl">
        ...
        <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <Input aria-label="Organization Name" name="name" defaultValue={organization.name} required />
          </div>
        </section>
        ...
        <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <Input aria-label="Street Address" name="address_street" defaultValue={organization.address_street || ''} />
          </div>
        </section>
        ...
        <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <Input aria-label="City" name="address_city" defaultValue={organization.address_city || ''} />
          </div>
        </section>
        ...
        <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <Select name="address_state" defaultValue={organization.address_state || 'CA'} required>
        ...
        <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <Input aria-label="Postal Code" name="address_postal_code" defaultValue={organization.address_postal_code || ''} />
          </div>
        </section>
